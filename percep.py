...
play recording 1
	random L/R and correspondent to sentence displayed
play recording 2
make a choice"""
...
exp = xpy.design.Experiment(name="perception")
...
instr_trial("""Vous allez voir une phrase sur l'ecran, et puis deux possibles phrases rejointes.\n
	Choisissez l'une qui, d'apres vous, est plus naturelle.\n
